...
const paddleBounceAudio = new Audio(src="plip.wav");
const borderBounceAudio = new Audio(src="blip.wav");
const scoreAudio = new Audio(src="wrong.wav");
